...
def _mediapipe_face_detection(
    ...
    *,
    ...
    try:
        ...
        raise BackendDependencyError("MediaPipe face detection", "mediapipe is required") from exc
    ...
    try:
        ...
        raise BackendLoadError("MediaPipe face detection", "detector initialization failed") from exc
    try:
        try:
            ...
            raise BackendInferenceError("MediaPipe face detection", "frame evaluation failed") from exc
    finally:
